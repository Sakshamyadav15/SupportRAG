    ...
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen font-sans antialiased">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 z-30 flex flex-col px-6 md:px-12 pb-12 max-w-3xl">
          ...
          >
            AI-Powered<br />Customer Support<br />That Never<br />Sleeps.
          </h1>

          {/* 3 metrics — staggered after title */}
          <div className="flex gap-8 sm:gap-12">
            {[
              { value: "4.2x", label: "Throughput" },
              { value: "337ms", label: "Latency" },
              { value: "15.5K+", label: "Documents" },
            ].map((stat, i) => (
              <div
                key={i}
                style={{
          ...
          <div className="grid grid-cols-12 grid-rows-auto gap-3" onMouseMove={handleMouse}>
            ...
            <BentoCard className="col-span-12 p-8 min-h-[200px] flex flex-col justify-between relative overflow-hidden" delay={0}>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-light mb-3">Dual Store Architecture</h3>
                <p className="text-sm text-black/45 leading-relaxed max-w-sm">
                  FAQ Store with 10,580 documents + Ticket Store with 5,000 historical tickets. Smart fallback searches FAQ first, falls back to Tickets if confidence is below 65%.
                </p>
              </div>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={120}>
              ...
              <h3 className="text-lg font-light mb-2">FAISS IVF Indexing</h3>
              <p className="text-sm text-black/45 leading-relaxed">Clustered indexing with 205/141 clusters for 3-10x faster retrieval with 99% accuracy.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={160}>
              ...
              <h3 className="text-lg font-light mb-2">Async Processing</h3>
              <p className="text-sm text-black/45 leading-relaxed">Parallel queries with ThreadPoolExecutor for 4.2x throughput improvement over sequential.</p>
            </BentoCard>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              ...
              <div className="mt-4"><Tag>DATA SOURCES</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
                {"Intelligent data stores\nfor accurate answers."}
              </RevealText>
            </div>
            <p className="text-sm text-black/45 leading-relaxed max-w-xs">
              Dual vector stores with smart fallback logic. FAQs for common questions, historical tickets for edge cases.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              ...
              <div className="mt-4"><Tag>TECH STACK</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
                {"Production-ready.\nBattle-tested tools."}
              </RevealText>
            </div>
          ...
          <div className="rounded-2xl overflow-hidden border border-black/[0.07] flex flex-col md:block md:relative" onMouseMove={handleMouse}>
            ...
            <div className="flex flex-col gap-3 p-4 md:absolute md:bottom-4 md:right-4 md:p-0 md:w-72">
              ...
              >
                <Tag>API</Tag>
                <h3 className="mt-3 text-lg font-light mb-2">REST Endpoints</h3>
                <p className="text-xs text-black/45 leading-relaxed mb-4">Query the RAG system with simple POST requests. Full async support.</p>
                <div className="bg-black/[0.05] rounded-lg border border-black/[0.07] p-3 font-mono text-[11px] text-black/50 leading-relaxed">
                  <span className="text-black/25"># Query endpoint</span><br />
                  <span className="text-blue-600/70">POST</span>{" /query"}<br />
                  {"  "}<span className="text-amber-700/70">question</span>: <span className="text-green-700/70">&quot;How do I reset?&quot;</span><br />
                  {"  "}<span className="text-amber-700/70">top_k</span>: <span className="text-black/35">3</span><br />
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-black/40 tracking-widest">LIVE STATS</span>
                </div>
                <p className="text-sm text-black/45">Real-time metrics, latency tracking, confidence distribution, and source breakdown.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="security" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            <PixelIcon type="platform" size={40} />
            <div className="mt-4"><Tag>MONITORING</Tag></div>
            <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
              {"Production-ready\nmonitoring built-in."}
            </RevealText>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <p className="text-sm text-black/45 leading-relaxed">
                Real-time metrics, comprehensive logging, and performance benchmarks. Know exactly how your RAG system performs.
              </p>

              <div className="space-y-4">
                {[
                  { label: "Query Logging", desc: "Complete query history saved in JSONL format" },
                  { label: "Latency Tracking", desc: "Monitor response times with percentile breakdowns" },
                  { label: "Confidence Metrics", desc: "Track confidence distribution across queries" },
                ].map((item) => (
            ...
            {/* Right side — live metrics visualization */}
            <BentoCard className="p-6 lg:row-span-1" delay={0}>
              <div className="text-xs text-black/30 tracking-widest uppercase mb-4">Live Query Metrics</div>
              <div className="space-y-2">
                {[
                  { time: "12:34:21", action: "query_processed", status: "success" },
                  { time: "12:34:18", action: "faq_search_complete", status: "success" },
                  { time: "12:34:15", action: "ticket_fallback", status: "success" },
                  { time: "12:34:12", action: "llm_generation", status: "success" },
                  { time: "12:34:09", action: "response_sent", status: "success" },
                ].map((log, i) => (
                  <div
                    key={i}
      ...
      <section className="py-0 border-t border-black/[0.06] overflow-hidden select-none">
        <div className="flex border-b border-black/[0.06]" style={{ animation: "marqueeLeft 28s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Password Reset", "Order Tracking", "Refund Queries", "Account Issues", "Payment Help", "Shipping Info", "Product Support", "Billing Questions", "Technical Support", "FAQ Lookup"].map((cap) => (
        ...
        <div className="flex" style={{ animation: "marqueeRight 22s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Ticket History", "Resolution Status", "Confidence Scoring", "Source Tracking", "Async Queries", "Vector Search", "Smart Fallback", "Citation Generation", "Latency Metrics", "Real-time Stats"].map((cap) => (
                <div key={cap} className="flex items-center gap-6 px-10 py-5 border-r border-black/[0.06] shrink-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="mt-6 text-base text-black/40 leading-relaxed max-w-sm">
                Customer questions answered in milliseconds. No wait times, no queues, no human intervention required.
              </p>
              <div className="mt-10 flex items-end gap-2">
                <LiveAgentCounter />
                <span className="text-black/30 text-sm mb-1 tracking-wide">queries processed today</span>
              </div>
            </div>
            ...
            {[
              {
                ...
                features: ["5K queries/mo", "Basic FAQ store", "Community support", "API access"],
                delay: 0,
              },
              {
                name: "Pro",
                ...
                features: ["100K queries/mo", "Dual vector stores", "Priority support", "Full metrics", "Custom embeddings", "Webhook integrations"],
                highlight: true,
                delay: 80,
              },
              {
                ...
                features: ["Unlimited queries", "Dedicated infra", "Custom LLM models", "SLA guarantees", "On-premise option", "24/7 support"],
                delay: 140,
              },
            ].map((plan) => (
              <BentoCard
      ...
      <section className="relative py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <a
            href="/chat"
            className="inline-flex px-10 py-4 bg-[#111] text-white text-sm rounded-xl hover:bg-[#333] transition-colors tracking-widest font-medium"
          >
            TRY IT OUT
          </a>
        </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              { label: "Terms",   href: "#" },
              { label: "Docs",    href: "#" },
              { label: "GitHub",  href: "https://github.com/Sakshamyadav15/SupportRAG" },
            ].map(l => (
