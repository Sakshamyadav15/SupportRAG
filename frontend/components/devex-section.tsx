...
const STEPS = [
  {
    num: "01",
    title: "Install",
    desc: "Clone and setup dependencies",
    file: "terminal",
    lang: "bash",
    code: [
      ...
      { type: "gap" },
      { type: "output", text: "✓ FAISS installed" },
      { type: "output", text: "✓ LangChain ready" },
      { type: "output", text: "✓ FastAPI configured" },
    ],
  },
  {
    num: "02",
    title: "Build Stores",
    desc: "Create dual vector stores",
    file: "scripts/build.py",
    lang: "python",
    code: [
      { type: "comment", text: "# Build vector stores with IVF" },
      { type: "keyword", text: "from", after: " dual_rag_pipeline ", keyword2: "import", string: " DualStoreRAGPipeline" },
      { type: "gap" },
      { type: "keyword", text: "pipeline", after: " ", keyword2: "=", keyword3: " ", fn: "DualStoreRAGPipeline", args: "()" },
      { type: "plain", text: "pipeline.build_vector_stores(use_ivf=True)" },
      { type: "plain", text: "pipeline.save_vector_stores()" },
      { type: "gap" },
      { type: "comment", text: "# ~3-4 minutes for 15.5k docs" },
    ],
  },
  {
    num: "03",
    title: "Query API",
    desc: "Send questions via REST",
    file: "example.py",
    lang: "python",
    code: [
      { type: "comment", text: "# Query the RAG system" },
      { type: "keyword", text: "import", after: " requests", keyword2: "", string: "" },
      { type: "gap" },
      { type: "keyword", text: "response", after: " ", keyword2: "=", keyword3: " requests.", fn: "post", args: "(" },
      { type: "prop", key: "  url", val: "'localhost:8000/query'" },
      { type: "prop", key: "  json", val: "{'question': '...'}" },
      { type: "plain", text: ")" },
    ],
  },
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Start the API server" },
      { type: "command", text: "uvicorn src.api.main:app --reload" },
      { type: "gap" },
      { type: "output", text: "  Loading vector stores..." },
      { type: "output", text: "  Starting FastAPI..." },
      { type: "gap" },
      { type: "success", text: "✓ API running on :8000" },
      { type: "url", text: "  → http://localhost:8000/docs" },
    ],
  },
]
