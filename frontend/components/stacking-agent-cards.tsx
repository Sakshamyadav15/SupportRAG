...
const AGENTS = [
  {
    label: "FAQ STORE",
    title: "10,580 FAQ documents",
    desc: "Combines 580 local CSV FAQs with 10,000 from Bitext HuggingFace dataset. FAISS IVF indexed with 205 clusters for lightning-fast semantic search.",
    stats: [{ v: "10.5K", l: "documents" }, { v: "205", l: "clusters" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/researcher-CvhqOuV6irGwBOnJoTGFlXdbyYBRjb.png",
  },
  {
    label: "TICKET STORE",
    title: "5,000 support tickets",
    desc: "Historical support tickets with resolution status, categories, and metadata. Falls back when FAQ confidence drops below 65% threshold.",
    stats: [{ v: "5K", l: "tickets" }, { v: "141", l: "clusters" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coder-9bItvCegU6TXUqbX3tUXGBAtvkBkXp.png",
  },
  {
    label: "EMBEDDINGS",
    title: "MiniLM-L6-v2 model",
    desc: "sentence-transformers/all-MiniLM-L6-v2 generates 384-dimensional embeddings. Optimized for semantic similarity with fast inference.",
    stats: [{ v: "384", l: "dimensions" }, { v: "99%", l: "accuracy" }],
